...
class DataAnalyzer:
    ...
    def analyze_data(self):
        ...
        while column_index < len(self.df.columns):
            ...
            info_text = f"Max: {max_value:.4f} at {max_time} ms\nMin: {min_value:.4f} at {min_time} ms"
    ...
    def save_points_info_to_excel(self):
        ...
        df = pd.DataFrame(self.points_info, columns=['Column Name', 'Time (ms) of Min', 'Time (ms) of Max', 'Acceleration of Min', 'Acceleration of Max'])
